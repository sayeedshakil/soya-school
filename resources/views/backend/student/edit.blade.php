            ...
            <div class="card-body">
                <form action="{{ route('backend.students.update', [$student->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group {{ $errors->has('fName') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="fName" id="fName"  class="form-control" value="{{ old('fName', isset($student) ? $student->fName : '') }}" required>
                        @if($errors->has('fName'))
                    ...
                    <div class="form-group {{ $errors->has('lName') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="lName" id="lName"  class="form-control" value="{{ old('lName', isset($student) ? $student->lName : '') }}" required>
                        @if($errors->has('lName'))
                            <em class="invalid-feedback">
                                {{ $errors->first('lName') }}
                            </em>
                    ...
                    <div class="form-group {{ $errors->has('dateOfBirth') ? 'has-error' : '' }}">
                        ...
                        <input type="date" name="dateOfBirth" id="dateOfBirth"  class="form-control" value="{{ old('dateOfBirth',$student->dateOfBirth ) }}">
                    ...
                    <div class="form-check form-group {{ $errors->has('gender') ? 'has-error' : '' }}">
                        <input class="form-check-input" type="radio" name="gender" id="flexRadioDefault1"  value="Male"  @if ($student->gender == 'Male') checked @endif>
                        <label class="form-check-label" for="flexRadioDefault1" >
                          Male
                        </label>
                      </div>
                      <div class="form-check form-group {{ $errors->has('gender') ? 'has-error' : '' }} ">
                        <input class="form-check-input " type="radio" name="gender" id="flexRadioDefault2" value="Female" @if ($student->gender == 'Female') checked @endif>
                    ...
                    <div class="form-check form-group {{ $errors->has('religion') ? 'has-error' : '' }}">
                        <input class="form-check-input" type="radio" name="religion" id="flexRadioDefault1"  value="Muslim" @if ($student->religion == 'Muslim') checked @endif>
                        <label class="form-check-label" for="flexRadioDefault1" >
                          Muslim
                        </label>
                      </div>
                      <div class="form-check form-group {{ $errors->has('religion') ? 'has-error' : '' }} ">
                        <input class="form-check-input " type="radio" name="religion" id="flexRadioDefault2" value="Hindu" @if ($student->religion == 'Hindu') checked @endif>
                        <label class="form-check-label" for="flexRadioDefault2">
                          Hindu
                        </label>
                    ...
                    <div class="form-group {{ $errors->has('mobile') ? 'has-error' : '' }}">
                        ...
                        <input type="number" name="mobile" id="mobile"  class="form-control" value="{{ old('mobile', isset($student) ? $student->mobile : '') }}">
                    ...
                    <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                        ...
                        <input type="email" placeholder="example@gmail.com" name="email" id="email"  class="form-control" value="{{ old('email', isset($student) ? $student->email : '') }}">
                        @if($errors->has('email'))
                            <em class="invalid-feedback">
                                {{ $errors->first('email') }}
                            </em>
                    ...
                    <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                        ...
                        <textarea id="address" class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" >{{ old('address', isset($student) ? $student->address : '') }}</textarea>
                    ...
                    <div class="form-group {{ $errors->has('studentclass') ? 'has-error' : '' }}">
                        ...
                        <select name="studentclass" id="studentclass" class="form-control" required>
                            ...
                            @foreach($classes as $id => $entry)
                                <option value="{{ $id }}" {{ (old('studentclass') ? old('studentclass') : $student->studentclass_id ?? '') == $id ? 'selected' : '' }} >{{ $entry}}</option>
                            @endforeach
                    ...
                    <div class="form-group {{ $errors->has('rollNumber') ? 'has-error' : '' }}">
                        ...
                        <input type="number" name="rollNumber" id="rollNumber"  class="form-control" value="{{ old('rollNumber', isset($student) ? $student->rollNumber : '') }}">
                    ...
                    <div class="form-group {{ $errors->has('admissionDate') ? 'has-error' : '' }}">
                        ...
                        <input type="date" name="admissionDate" id="admissionDate"  class="form-control" value="{{ old('admissionDate', isset($student) ? $student->admissionDate : '') }}">
                    ...
                    <label for="studentImage">{{ trans('cruds.student.studentImage') }}</label>
                    <div class="form-group text-center" {{ $errors->has('studentImage') ? 'has-error' : '' }} style="background-color: #f1f1f1;
                        ...
                        <div>
                            @if($student->studentImage)
                                <img src="{{asset('storage/images/students/' . $student->studentImage)}}" onclick="triggerClick()" style="max-height:180px;border-radius: 3px;" id="previewImage" alt="click here to add an image" title="click here to add your image">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="form-group {{ $errors->has('fatherName') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="fatherName" id="fatherName"  class="form-control" value="{{ old('fatherName', isset($student) ? $student->fatherName : '') }}" required>
                    ...
                    <div class="form-group {{ $errors->has('fatherMobile') ? 'has-error' : '' }}">
                        ...
                        <input type="number" name="fatherMobile" id="fatherMobile"  class="form-control" value="{{ old('fatherMobile', isset($student) ? $student->fatherMobile : '') }}">
                    ...
                    <div class="form-group {{ $errors->has('fatherOccupation') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="fatherOccupation" id="fatherOccupation"  class="form-control" value="{{ old('fatherOccupation', isset($student) ? $student->fatherOccupation : '') }}">
                    ...
                    <div class="form-group {{ $errors->has('motherName') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="motherName" id="motherName"  class="form-control" value="{{ old('motherName', isset($student) ? $student->motherName : '') }}" required>
                    ...
                    <div class="form-group {{ $errors->has('motherMobile') ? 'has-error' : '' }}">
                        ...
                        <input type="number" name="motherMobile" id="motherMobile"  class="form-control" value="{{ old('motherMobile', isset($student) ? $student->motherMobile : '') }}">
                    ...
                    <div class="form-group {{ $errors->has('motherOccupation') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="motherOccupation" id="motherOccupation"  class="form-control" value="{{ old('motherOccupation', isset($student) ? $student->motherOccupation : '') }}">
