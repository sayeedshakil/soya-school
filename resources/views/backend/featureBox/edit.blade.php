...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('backend.feature_box.update', [$featureBox->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group {{ $errors->has('is_active') ? 'has-error' : '' }}">
                ...
                <select name="is_active" id="is_active" class="form-control" required>
                        ...
                        <option value="{{ 0 }}" @if (0 == $featureBox->is_active) selected @endif>{{ 'In-Active' }}</option>
                        <option value="{{ 1 }}" @if (1 == $featureBox->is_active) selected @endif>{{ 'Active' }}</option>
            ...
            <div class="form-group {{ $errors->has('feature_title') ? 'has-error' : '' }}">
                ...
                <input type="text" id="feature_title" name="feature_title" class="form-control" value="{{ old('feature_title', isset($featureBox) ? $featureBox->feature_title : '') }}" required>
            ...
            <div class="form-group text-center" {{ $errors->has('feature_image') ? 'has-error' : '' }} style="background-color: #f1f1f1;
                ...
                <div>
                    @if($featureBox->feature_image)
                        <img src="{{asset('storage/images/featureBox/' . $featureBox->feature_image)}}" onclick="triggerClick()" style="max-height:180px;border-radius: 3px;" id="previewImage" alt="click here to add an image" title="click here to add your image">
                        <input type="file" name="feature_image" id="profileImage" style="display: none;"
                        ...
                        <div class="text-muted" style="font-size: .80rem;">
                            <span class=""> Supported file types jpg,jpeg,png.(Max 512KB)</span>
                        </div>
                        </div>
                    @else
            ...
            <div class="row">
                <div class="col-md-6 form-group {{ $errors->has('feature_subtitle1') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="feature_subtitle1" name="feature_subtitle1" class="form-control" value="{{ old('feature_subtitle1', isset($featureBox) ? $featureBox->feature_subtitle1 : '') }}" placeholder="https://example.com">
                ...
                <div class="col-md-6 form-group {{ $errors->has('feature_subtitle_link1') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="feature_subtitle_link1" name="feature_subtitle_link1" class="form-control" value="{{ old('feature_subtitle_link1', isset($featureBox) ? $featureBox->feature_subtitle_link1 : '') }}" placeholder="https://example.com">
            ...
            <div class="row">
                <div class="col-md-6 form-group {{ $errors->has('feature_subtitle2') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="feature_subtitle2" name="feature_subtitle2" class="form-control" value="{{ old('feature_subtitle2', isset($featureBox) ? $featureBox->feature_subtitle2 : '') }}" placeholder="https://example.com">
                ...
                <div class="col-md-6 form-group {{ $errors->has('feature_subtitle_link2') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="feature_subtitle_link2" name="feature_subtitle_link2" class="form-control" value="{{ old('feature_subtitle_link2', isset($featureBox) ? $featureBox->feature_subtitle_link2 : '') }}" placeholder="https://example.com">
            ...
            <div class="row">
                <div class="col-md-6 form-group {{ $errors->has('feature_subtitle3') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="feature_subtitle3" name="feature_subtitle3" class="form-control" value="{{ old('feature_subtitle3', isset($featureBox) ? $featureBox->feature_subtitle3 : '') }}" placeholder="https://example.com">
                ...
                <div class="col-md-6 form-group {{ $errors->has('feature_subtitle_link3') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="feature_subtitle_link3" name="feature_subtitle_link3" class="form-control" value="{{ old('feature_subtitle_link3', isset($featureBox) ? $featureBox->feature_subtitle_link3 : '') }}" placeholder="https://example.com">
