...
class ExpenseController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.expenses.create', compact('expense_categories'));
    }
    ...
    public function store(StoreExpenseRequest $request)
    {
        ...
        return redirect()->route('backend.expenses.index');
    }
    ...
    public function edit(Expense $expense)
    {
        ...
        return view('backend.expenses.edit', compact('expense_categories', 'expense'));
    }
